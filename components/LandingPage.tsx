    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative h-9 w-9 overflow-hidden rounded-xl border border-border shadow-lg shadow-primary/20">
              <Image src="/logo.png" alt="Dhanvantari Logo" fill className="object-cover" />
            </div>
            <div>
              <p className="text-sm font-bold tracking-tight leading-tight text-foreground">Dhanvantari</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <WipeToggler />
      ...
      <section className="relative pt-24 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-playfair font-black tracking-tight leading-[1.05] mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <Link href="/sign-in">
              <Button size="lg" variant="ghost" className="h-13 px-8 text-base text-muted-foreground hover:text-foreground hover:bg-accent border border-border">
          ...
          {/* Stats Bar */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-border rounded-2xl border border-border overflow-hidden max-w-3xl mx-auto">
            {stats.map((s) => (
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-foreground mb-4">Built for the real pharmacy floor</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map((f) => (
              <div
                key={f.title}
                className={`group relative rounded-2xl border ${f.border} ${f.bg} p-6 hover:border-primary/30 transition-all duration-300 hover:-translate-y-1`}
              >
      ...
      <section className="py-24 border-t border-border/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-foreground mb-4">Up and running in minutes</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {steps.map((step) => (
              <div key={step.num} className="text-center relative">
                <div className="inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-muted border border-border text-2xl font-black text-muted-foreground mb-5 mx-auto">
                  {step.num}
                </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="relative rounded-3xl overflow-hidden border border-primary/20 bg-gradient-to-br from-primary/10 via-violet-500/5 to-cyan-500/5 p-12 text-center">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-muted border border-border text-muted-foreground text-xs font-medium mb-6">
            ...
            <Link href="/sign-up">
              <Button size="lg" className="px-10 h-13 text-base bg-foreground text-background hover:bg-foreground/90 font-bold shadow-2xl">
      ...
      <footer className="border-t border-border/40 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-foreground/70">Dhanvantari</span>
          </div>
